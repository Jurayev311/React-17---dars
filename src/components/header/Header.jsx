...
import { FaBookmark, FaSearch, FaRegSun, FaBars, FaTimes, FaRegMoon } from 'react-icons/fa';
...
const Header = () => {
  ...
  return (
    <>
      <header id='header' className='sticky bg-slate-100 text-gray-900 top-0 left-0 z-40 dark:bg-[#000000d8] dark:text-white flex items-center h-14'>
        <div className='container-all mx-auto flex items-center justify-between px-6'>
          ...
          <div className='hidden md:flex items-center gap-4'>
            ...
            <button onClick={handleDarkMode} className='px-4 py-2 rounded-md cursor-pointer'>
      ...
      <div id='sidebar' className={`fixed top-0 right-0 h-full w-64 bg-slate-200 text-gray-900 dark:text-white dark:bg-[#000000f8] z-50 transform transition-transform duration-300 ease-in-out ${isSidebarOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        ...
        <div className='mt-8 pl-6'>
          ...
          <button className='mt-4 px-4 py-2 rounded-md cursor-pointer' onClick={handleDarkMode}>
            {dark ? <FaRegSun /> : <FaRegMoon />}
          </button>
        </div>
      </div>
